...
@section('content')
    ...
    <div id="hero-section" class="relative h-[590px] w-full overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('frontend/images/hero-section.jpeg') }}" alt="Background" class="w-full h-full object-cover grayscale brightness-50" />
        </div>
    ...
    <section class="bg-gray-100 py-16 px-6 md:px-20">
      <div class="max-w-7xl mx-auto">
        <div
          class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-2 items-start"
        >
          ...
          <div>
            <p
              class="text-gray-500 text-base md:text-lg leading-relaxed mb-8 text-justify"
            >
    ...
    <section class="py-16 px-6 md:px-20">
      <div
        class="mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4"
      >
        ...
        >
          <div class="flex justify-between items-start mb-4">
            ...
            <div class="flex -space-x-2">
              <div
                class="w-8 h-8 rounded-full bg-stone-600 border-2 border-white"
              ></div>
              <div
                class="w-8 h-8 rounded-full bg-rose-900 border-2 border-white"
              ></div>
              <div
          ...
          <a
            href="#"
            class="text-[#7753AF] font-semibold text-sm hover:underline"
    ...
    <!-- inventarsi -->
      <section class="px-6 md:px-20">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-6">
          ...
          <!-- 1 -->
          <div data-aos="fade-up" class="w-full bg-white border-2 border-gray-200 rounded-3xl flex flex-col hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
              <div class="relative w-full h-56 bg-gray-100 rounded-2xl flex items-center justify-center overflow-hidden">
                  <span class="absolute top-4 left-4 bg-white text-[10px] font-bold px-3 py-1 rounded-full shadow-sm border border-gray-100 uppercase tracking-wide text-gray-600">
                      Kategori
                  </span>
                  <img src="https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&q=80&w=300" 
                      alt="Tas Gunung" 
                      class="h-4/5 object-contain mix-blend-multiply">
              </div>
              ...
              <div class=" p-5 flex justify-between items-end">
                  ...
                  <button class="w-12 h-12 bg-[#7753AF] rounded-xl flex items-center justify-center text-white hover:bg-[#5e3d8e] transition shadow-md group">
          ...
          <!-- 2 -->
          <div data-aos="fade-up" data-aos-delay="100" class="w-full bg-white border-2 border-gray-200 rounded-3xl flex flex-col hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
              <div class="relative w-full h-56 bg-gray-100 rounded-2xl flex items-center justify-center overflow-hidden">
                  <span class="absolute top-4 left-4 bg-white text-[10px] font-bold px-3 py-1 rounded-full shadow-sm border border-gray-100 uppercase tracking-wide text-gray-600">
                      Kategori
                  </span>
              ...
              <div class=" p-5 flex justify-between items-end">
                  <div>
                      <h3 class="text-gray-900 font-bold text-lg leading-tight">Mountain <br> Backpack 60L</h3>
                      <p class="text-gray-500 text-sm mt-1">2 Unit</p>
                  </div>
                  <button class="w-12 h-12 bg-[#7753AF] rounded-xl flex items-center justify-center text-white hover:bg-[#5e3d8e] transition shadow-md group">
                      <i class="fa-solid fa-arrow-right -rotate-45 group-hover:-rotate-0 transition-transform duration-300"></i>
          ...
          <!-- 3 -->
          <div data-aos="fade-up" data-aos-delay="200" class="w-full bg-white border-2 border-gray-200 rounded-3xl flex flex-col hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
              <div class="relative w-full h-56 bg-gray-100 rounded-2xl flex items-center justify-center overflow-hidden">
                  <span class="absolute top-4 left-4 bg-white text-[10px] font-bold px-3 py-1 rounded-full shadow-sm border border-gray-100 uppercase tracking-wide text-gray-600">
                      Kategori
                  </span>
          ...
          <!-- 4 -->
          <div data-aos="fade-up" data-aos-delay="300" class="w-full bg-white border-2 border-gray-200 rounded-3xl flex flex-col hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
              <div class="relative w-full h-56 bg-gray-100 rounded-2xl flex items-center justify-center overflow-hidden">
                  <span class="absolute top-4 left-4 bg-white text-[10px] font-bold px-3 py-1 rounded-full shadow-sm border border-gray-100 uppercase tracking-wide text-gray-600">
                      Kategori
                  </span>
          ...
          <!-- 5 -->
          <div data-aos="fade-up" data-aos-delay="400" class="w-full bg-white border-2 border-gray-200 rounded-3xl flex flex-col hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
              <div class="relative w-full h-56 bg-gray-100 rounded-2xl flex items-center justify-center overflow-hidden">
                  <span class="absolute top-4 left-4 bg-white text-[10px] font-bold px-3 py-1 rounded-full shadow-sm border border-gray-100 uppercase tracking-wide text-gray-600">
                      Kategori
                  </span>
    ...
    <section class="py-20 px-6 md:px-20">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <!-- 1 -->
        <div class="relative h-[300px] rounded-2xl overflow-hidden group cursor-pointer shadow-md hover:shadow-xl transition-all duration-300">
          <div class="absolute top-4 left-4 z-20 bg-white text-gray-800 text-xs font-medium px-3 py-1.5 rounded-full flex items-center gap-2 shadow-sm">
              <i class="fa-regular fa-calendar"></i> <span>07 Nov 2025</span>
          </div>
          <img src="{{ asset('frontend/images/artikel-1.jpeg') }}" 
              class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110">
          <div class="absolute bottom-0 left-0 w-full h-[40%] z-10 flex flex-col justify-end p-6 bg-gradient-to-t from-black/90 via-black/60 to-transparent backdrop-blur-md">
              <h3 class="text-white text-xl font-bold leading-tight mb-3 drop-shadow-md">
                  Ekspedisi Pendakian <br> Gunung Merapi 2025
              </h3>
              <a href="#" class="inline-flex items-center text-white text-sm font-semibold hover:text-purple-300 transition-colors group/btn">
                  Read More
                  <i class="fa-solid fa-arrow-right ml-2 text-xs transform transition-transform group-hover/btn:translate-x-1"></i>
              </a>
          </div>
        </div>
