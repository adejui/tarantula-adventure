        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                ...
                <nav class="flex text-sm font-medium text-gray-500">
                    ...
                    <a href="{{ route('frontend.inventory') }}" class="hover:text-[#7C3AED] transition-colors">Inventaris</a>
                    <span class="mx-2">/</span>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-[2rem] border border-gray-100 p-8 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-xs font-bold text-gray-700 uppercase tracking-wide mb-2">Tanggal
                                    Pinjam</label>
                                <div class="relative">
                                    <input type="date"
                            ...
                            <div class="md:col-span-2">
                                <label class="block text-xs font-bold text-gray-700 uppercase tracking-wide mb-2">Keperluan
                                    Peminjaman</label>
                                <textarea rows="4"
                                    class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-[#7C3AED] focus:bg-white transition-all text-sm font-medium text-gray-900 placeholder-gray-400"
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-[2rem] border border-gray-100 p-6 shadow-sm sticky top-32">
                        ...
                        <div class="space-y-4 mb-8 max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                            ...
                            <div
                                ...
                                <div
                                    class="h-20 w-20 flex-shrink-0 bg-gray-100 rounded-xl overflow-hidden flex items-center justify-center border border-gray-100">
                                ...
                                <div class="flex flex-col justify-center">
                                    <h4 class="font-bold text-gray-900 text-sm line-clamp-2 leading-tight">Mountain Backpack
                                        60L</h4>
                                    <div class="flex items-center gap-2 mt-1">
                                        <span
                                            class="text-[10px] bg-gray-100 text-gray-500 px-2 py-0.5 rounded font-mono">#TS001</span>
                                        <span class="text-xs text-gray-400">|</span>
                                        <span class="text-xs font-bold text-[#7C3AED]">1 Unit</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-col justify-center">
                                    <h4 class="font-bold text-gray-900 text-sm line-clamp-2 leading-tight">Tenda Dome 4P
                                        Double Layer</h4>
                                    <div class="flex items-center gap-2 mt-1">
                                        <span
                                            class="text-[10px] bg-gray-100 text-gray-500 px-2 py-0.5 rounded font-mono">#TD045</span>
                                        <span class="text-xs text-gray-400">|</span>
                                        <span class="text-xs font-bold text-[#7C3AED]">2 Unit</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-col justify-center">
                                    <h4 class="font-bold text-gray-900 text-sm line-clamp-2 leading-tight">Kompor Portable
                                        Windproof</h4>
                                    <div class="flex items-center gap-2 mt-1">
                                        <span
                                            class="text-[10px] bg-gray-100 text-gray-500 px-2 py-0.5 rounded font-mono">#KP012</span>
                                        <span class="text-xs text-gray-400">|</span>
                                        <span class="text-xs font-bold text-[#7C3AED]">1 Unit</span>
                                    </div>
                                </div>
