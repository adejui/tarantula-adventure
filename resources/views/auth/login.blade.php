...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="p-24 min-h-screen">

        <div class="min-h-[calc(100vh-6rem)] flex">

            <!-- LEFT SIDE -->
            <div class="hidden md:flex w-1/2 bg-gray-300 items-center justify-center p-10 rounded-2xl">
                <div class="max-w-sm">
            ...
            <!-- RIGHT SIDE (FORM) -->
            <div class="flex w-full md:w-1/2 items-center justify-center p-8 bg-white rounded-2xl">
