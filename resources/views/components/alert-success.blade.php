...
setTimeout(() => show = false, 6000);" x-show="show"
    ...
    class="fixed top-24 right-6 z-50 flex justify-between w-full max-w-[558px] p-4 rounded-[15px] bg-[#96DAA4] text-gray-800 shadow-md border">

    <div class="flex items-start space-x-3">
        <img src="{{ asset('assets/images/icons/check-circlee.svg') }}" alt="Success" class="w-7 h-7">

        <div>
            <h4 class="font-semibold text-[#00a520] mb-1">
                {{ $title ?? 'Berhasil!' }}
            </h4>
