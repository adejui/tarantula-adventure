                ...
                <ul class="mb-6 flex flex-col gap-4">
                    ...
                    <li x-data="{
                        ...
                        <a href="#" @click.prevent="selected = (selected === 'Kegiatan' ? '' : 'Kegiatan')"
                            class="menu-item group" :class="isActive ? 'menu-item-active' : 'menu-item-inactive'">

                            <svg :class="isActive ? 'menu-item-icon-active' : 'menu-item-icon-inactive'" width="24"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[
                                    (selected === 'Kegiatan') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive',
                    ...
                    {{ Route::currentRouteName() == 'activities*' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive' }}">
                                        Daftar Kegiatan
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="{{ route('activity-members.index') }}"
                                        class="menu-dropdown-item group
                    {{ Route::currentRouteName() == 'activity-members*' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive' }}">
                                        Anggota Kegiatan
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="{{ route('activity-documents.index') }}"
                                        class="menu-dropdown-item group
                    {{ Route::currentRouteName() == 'activity-documents.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive' }}">
                    ...
                    {{-- <li x-data="{ selected: '{{ in_array(Route::currentRouteName(), ['activities.index', 'activity-members.index', 'activity-documents.index']) ? 'Kegiatan' : '' }}' }">
                        <a href="#" @click.prevent="selected = (selected === 'Kegiatan' ? '' : 'Kegiatan')"
                            class="menu-item group"
                            :class="(selected === 'Kegiatan') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'Kegiatan') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M8 2C8.41421 2 8.75 2.33579 8.75 2.75V3.75H15.25V2.75C15.25 2.33579 15.5858 2 16 2C16.4142 2 16.75 2.33579 16.75 2.75V3.75H18.5C19.7426 3.75 20.75 4.75736 20.75 6V9V19C20.75 20.2426 19.7426 21.25 18.5 21.25H5.5C4.25736 21.25 3.25 20.2426 3.25 19V9V6C3.25 4.75736 4.25736 3.75 5.5 3.75H7.25V2.75C7.25 2.33579 7.58579 2 8 2ZM8 5.25H5.5C5.08579 5.25 4.75 5.58579 4.75 6V8.25H19.25V6C19.25 5.58579 18.9142 5.25 18.5 5.25H16H8ZM19.25 9.75H4.75V19C4.75 19.4142 5.08579 19.75 5.5 19.75H18.5C18.9142 19.75 19.25 19.4142 19.25 19V9.75Z"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Kegiatan') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive',
                                    sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="translate transform overflow-hidden"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{ route('activities.index') }}"
                                        class="menu-dropdown-item group
                        {{ Route::currentRouteName() == 'activities.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive' }}">
                                        Daftar Kegiatan
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="{{ route('activity-members.index') }}"
                                        class="menu-dropdown-item group
                        {{ Route::currentRouteName() == 'activity-members.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive' }}">
                                        Anggota Kegiatan
                                    </a>
                                </li>
                    ...
                    {{-- <li x-data="{ selected: '{{ in_array(Route::currentRouteName(), ['items.index', 'categories.index']) ? 'Inventoris' : '' }}' }">
                        <a href="#" @click.prevent="selected = (selected === 'Inventoris' ? '' : 'Inventoris')"
                            class="menu-item group"
                            :class="(selected === 'Inventoris') ? 'menu-item-active' : 'menu-item-inactive'">

                            <svg :class="(selected === 'Inventoris') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Inventoris') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive',
                                    sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Dropdown -->
                        <div class="translate transform overflow-hidden"
                            :class="(selected === 'Inventoris') ? 'block' : 'hidden'">
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                                <li>
                                    <a href="{{ route('items.index') }}"
                                        class="menu-dropdown-item group
                        {{ Route::currentRouteName() == 'items.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive' }}">
                                        Daftar Alat
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('categories.index') }}"
                                        class="menu-dropdown-item group
                        {{ Route::currentRouteName() == 'categories.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive' }}">
                                        Kategori
                                    </a>
                                </li>
                            </ul>
                    ...
                    <li x-data="{
                        ...
                        <a href="#" @click.prevent="selected = (selected === 'Inventoris' ? '' : 'Inventoris')"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[
                                    (selected === 'Inventoris' || isActive) ? 'menu-item-arrow-active' :
                    ...
                    <li x-data="{
                        ...
                        isActive: {{ in_array(Route::currentRouteName(), ['loans.index', 'borrowers.index', 'loan-details.index']) ? 'true' : 'false' }}
                    }">
                        <a href="#" @click.prevent="selected = (selected === 'Peminjaman' ? '' : 'Peminjaman')"
                            class="menu-item group" :class="isActive ? 'menu-item-active' : 'menu-item-inactive'">

                            <!-- ICON TETAP -->
                            <svg :class="isActive ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Peminjaman' || isActive) ? 'menu-item-arrow-active' :
                                    'menu-item-arrow-inactive',
                                    sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                            ...
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                ...
                                <li>
                                    <a href="{{ route('loans.index') }}"
                                        class="menu-dropdown-item group
                    {{ Route::currentRouteName() == 'loans.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive' }}">
                                        Daftar Peminjaman
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('borrowers.index') }}"
                                        class="menu-dropdown-item group
                    {{ Route::currentRouteName() == 'borrowers.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive' }}">
                                        Data Peminjam
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('loan-details.index') }}"
                                        class="menu-dropdown-item group
                    {{ Route::currentRouteName() == 'loan-details.index' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive' }}">
                                        Detail Peminjaman
                                    </a>
                                </li>
                            </ul>
                    ...
                    {{-- <li x-data="{ selected: '{{ in_array(Route::currentRouteName(), ['loans.index', 'borrowers.index', 'loan-details.index']) ? 'Peminjaman' : '' }}' }">
                        <a href="#" @click.prevent="selected = (selected === 'Peminjaman' ? '' : 'Peminjaman')"
                            class="menu-item group"
                            :class="(selected === 'Peminjaman') ? 'menu-item-active' : 'menu-item-inactive'">

                            <svg :class="(selected === 'Peminjaman') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M5.5 3.25C4.25736 3.25 3.25 4.25736 3.25 5.5V18.5C3.25 19.7426 4.25736 20.75 5.5 20.75H18.5001C19.7427 20.75 20.7501 19.7426 20.7501 18.5V5.5C20.7501 4.25736 19.7427 3.25 18.5001 3.25H5.5ZM4.75 5.5C4.75 5.08579 5.08579 4.75 5.5 4.75H18.5001C18.9143 4.75 19.2501 5.08579 19.2501 5.5V18.5C19.2501 18.9142 18.9143 19.25 18.5001 19.25H5.5C5.08579 19.25 4.75 18.9142 4.75 18.5V5.5ZM6.25005 9.7143C6.25005 9.30008 6.58583 8.9643 7.00005 8.9643L17 8.96429C17.4143 8.96429 17.75 9.30008 17.75 9.71429C17.75 10.1285 17.4143 10.4643 17 10.4643L7.00005 10.4643C6.58583 10.4643 6.25005 10.1285 6.25005 9.7143ZM6.25005 14.2857C6.25005 13.8715 6.58583 13.5357 7.00005 13.5357H17C17.4143 13.5357 17.75 13.8715 17.75 14.2857C17.75 14.6999 17.4143 15.0357 17 15.0357H7.00005C6.58583 15.0357 6.25005 14.6999 6.25005 14.2857Z"
                            ...
                            <svg class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                                :class="[(selected === 'Peminjaman') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive',
                                    sidebarToggle ? 'lg:hidden' : ''
                                ]"
                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Dropdown -->
                        <div class="translate transform overflow-hidden"
                            :class="(selected === 'Peminjaman') ? 'block' : 'hidden'">
                            <ul :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="menu-dropdown mt-2 flex flex-col gap-1 pl-9">
                                <li>
                                    <a href="{{ route('loans.index') }}"
                    ...
                    <li>
                        <a
                            href="{{ route('articles.index') }}"class="menu-item group {{ request()->routeIs('articles.index') ? 'menu-item-active' : 'menu-item-inactive' }}">

                            <svg class="{{ request()->routeIs('articles.index') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
