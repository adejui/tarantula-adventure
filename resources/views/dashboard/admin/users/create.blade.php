                ...
                <div class="flex justify-between items-center my-2">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button @click="showFilter = !showFilter" type="button"
                            ...
                            <img x-show="!showFilter" src="{{ asset('assets/images/icons/funnel.svg') }}"
                                alt="Filter Icon Light" class="w-4 h-4 opacity-70 block dark:hidden">
                            <img x-show="!showFilter" src="{{ asset('assets/images/icons/funnel-dark.svg') }}"
            ...
            <div x-show="showFilter" x-transition
                ...
                <div class="flex justify-start items-center my-2 gap-x-5">
                    ...
                    <div class="hs-dropdown [--auto-close:inside] relative">
                        <div class="flex flex-col">
                            ...
                            <button id="majorDropdownBtn" type="button"
                                class="hs-dropdown-toggle py-3 w-52 px-4 inline-flex items-center justify-between gap-x-2 text-sm font-normal rounded-lg border border-gray-300 bg-white text-gray-800 shadow-2xs focus:outline-hidden disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200 dark:focus:bg-gray-800"
                                aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                {{ ucfirst(request('major', 'All Prodi')) }}
                                <svg class="hs-dropdown-open:rotate-180 size-4" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg mt-2 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
                            ...
                            <div class="p-1 space-y-0.5">
                                ...
                                <button type="button" data-value="Sistem Informasi"
                                    class="major-option flex items-center w-full  gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                                    Sistem Informasi
                                </button>
                                <button type="button" data-value="Perhotelan"
                                    class="major-option flex items-center w-full  gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                                    Perhotelan
                                </button>
                            </div>
                    ...
                    <div class="hs-dropdown [--auto-close:inside] relative">
                        <div class="flex flex-col">
                            ...
                            <button id="generationDropdownBtn" type="button"
                                class="hs-dropdown-toggle py-3 w-52 px-4 inline-flex items-center justify-between gap-x-2 text-sm font-normal rounded-lg border border-gray-300 bg-white text-gray-800 shadow-2xs focus:outline-hidden disabled:opacity-50 disabled:pointer-events-none dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200 dark:focus:bg-gray-800"
                                aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                {{ ucfirst(request('generation', 'All Angkatan')) }}
                                <svg class="hs-dropdown-open:rotate-180 size-4" xmlns="http://www.w3.org/2000/svg"
                                    width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round">
                        ...
                        <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg mt-2 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700 after:h-4 after:absolute after:-bottom-4 after:start-0 after:w-full before:h-4 before:absolute before:-top-4 before:start-0 before:w-full"
                            ...
                            <div class="p-1 space-y-0.5">
                                ...
                                <button type="button" data-value="14"
                                    class="generation-option flex items-center w-full  gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                                    14
                                </button>
                                <button type="button" data-value="15"
                                    class="generation-option flex items-center w-full  gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                                    15
                                </button>
                            </div>
                    ...
                    <button id="resetFiltersBtn"
                        class="px-3 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg text-sm font-medium flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M4 4v5h.582m15.356 2A8.001 8.001 0 104.582 9M12 9v4l3 3" />
                        </svg>
                        Reset Filter
                    </button>
                </div>
                        ...
                        <div class="relative mb-4">
                            ...
                            <div x-data="{ showPassword: false }" class="relative">
                                <input :type="showPassword ? 'text' : 'password'" name="password"
                                    ...
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full appearance-none rounded-lg border bg-transparent bg-none px-4 py-3.5 pr-11 pl-4 text-xs text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('password') border-error-500 dark:border-error-500 @else border-gray-300 dark:border-gray-700 @enderror" />
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                            <div class="mb-4">
                                ...
                                <input type="text" name="nrp" id="nrp"
                                    ...
                                    class="text-[#212121] bg-gray-100 font-normal text-xs dark:text-white/90 h-11 w-full rounded-lg border px-4 py-2.5 pr-10 text-md placeholder:text-gray-400 focus:ring-0 focus:outline-hidden dark:bg-gray-900 dark:placeholder:text-white/30" />
                            </div>

                            <script>
                                document.getElementById('generation').addEventListener('input', function() {
                                    const generation = this.value.trim();
                                    if (generation) {
                                        fetch(`/generate-nrp/${generation}`)
                                            .then(res => res.json())
                                            .then(data => {
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="generation" value="{{ old('generation') }}"
                        ...
                        <div class="flex justify-end items-center w-full mt-8">
                            <div class="flex gap-5 w-full justify-end items-center">
                                ...
                                <a href="{{ route('users.index') }}" title="Hapus"
                                    class="p-2 border-2 text-sm border-[#7753AF] bg-transparent w-full rounded-lg text-[#7753AF] text-center hover:bg-[#F3E8FF] transition">
                                    Batal
                                </a>
